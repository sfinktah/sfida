...
# ida_ida.cvar.inf.min_ea - 0x94a20000 + 0x7ff5d3d90000
# BASE: 0x7ff67f370000
# END:  0x7ff68487fc00
# 
...
# print("offsets: {}".format(fix_dataseg_offsets(base=ida_ida.cvar.inf.min_ea, ori_base=0x7FF760840000 , size=0x04BF2000, seg_name='seg000', step=1)))
