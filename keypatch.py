...
def _get_name_value(_from, name):
    """
    Fixed: the return value truncated(32 bit) of _get_name_value function that analyzed 64 bit binary file about ida64 for win.
    ...
    def ida_resolve(self, assembly, address=idc.BADADDR):
        def _resolve(_op, ignore_kw=True):
            ...
            for name in names:
                ...
                (typ, value) = _get_name_value(address, sym)
